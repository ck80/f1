...
class RacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create race" do
    assert_difference('Race.count') do
      post races_url, params: { race: { country: @race.country, race_number: @race.race_number, year: @race.year } }
    end
  ...
  test "should update race" do
    patch race_url(@race), params: { race: { country: @race.country, race_number: @race.race_number, year: @race.year } }
